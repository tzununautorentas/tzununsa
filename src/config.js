...
const DARK = {
  ...
  acc:  "#00D4AA", sec:  "#F59E0B", red:  "#EF4444", blue: "#3B82F6",
...
// Colores tema CLARO
const LIGHT = {
  bg:   "#F0F4F8", surf: "#FFFFFF", card: "#FFFFFF", bord: "#CBD5E1",
  acc:  "#007A63", sec:  "#B45309", red:  "#DC2626", blue: "#1D4ED8",
  purple:"#7C3AED",green: "#15803D",
  txt:  "#1E293B", mut:  "#94A3B8", sub:  "#64748B",
};

// Función para cambiar tema (guarda y recarga la página)
export const toggleTheme = () => {
  localStorage.setItem("tz_theme", isDark ? "light" : "dark");
  window.location.reload();
};

// T exporta los colores del tema activo + aliases Dim/D
const _base = isDark ? DARK : LIGHT;
export const T = {
  ..._base,
  accD:    _base.acc    + "22", accDim:    _base.acc    + "22",
  secD:    _base.sec    + "22", secDim:    _base.sec    + "22",
  redD:    _base.red    + "22", redDim:    _base.red    + "22",
  blueD:   _base.blue   + "22", blueDim:   _base.blue   + "22",
  purpleD: _base.purple + "22", purpleDim: _base.purple + "22",
  greenD:  _base.green  + "22", greenDim:  _base.green  + "22",
};
...
export const S = {
  ...
  btn: (v) => ({
    ...
    color: (v === "primary" || v === "green") ? (isDark ? "#0A0F1E" : "#FFFFFF") : T.txt,
  }),
  srow: (hi) => ({
