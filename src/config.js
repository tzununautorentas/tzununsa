...
export const CATALOGO = [
  { id: "c1", nombre: "Hyundai Verna (Sedán)",   tipo: "Sedán",   dia: 300, sem: 275, mes: 250 },
  { id: "c2", nombre: "Toyota RAV4 Híbrida",     tipo: "SUV",     dia: 600, sem: 575, mes: 550 },
...
export const RUTAS = [
  ...
  { d: "Sacatepéquez",              km: 45,  dias: 1 },
  { d: "Chimaltenango",             km: 110, dias: 1 },
  { d: "Tecpán",                    km: 93,  dias: 1 },
  { d: "Sololá",                    km: 145, dias: 1 },
  { d: "Panajachel",                km: 140, dias: 1 },
  { d: "Chichicastenango",          km: 150, dias: 1 },
  { d: "Quiché (Sta. Cruz)",        km: 269, dias: 1 },
  { d: "Ixcán Quiché",              km: 385, dias: 3 },
  { d: "Nebaj",                     km: 235, dias: 2 },
  { d: "Cobán",                     km: 215, dias: 2 },
  { d: "Chisec Alta Verapaz",       km: 350, dias: 1 },
  { d: "Baja Verapaz (Salamá)",     km: 165, dias: 1 },
  ...
  { d: "Totonicapán",              km: 185, dias: 2 },
  { d: "Monterrico",                km: 140, dias: 1 },
  { d: "San José / Iztapa",         km: 115, dias: 1 },
  { d: "Semuc Champey",             km: 300, dias: 2 },
  { d: "Quiriguá",                  km: 215, dias: 1 },
  { d: "Ruinas Copán Honduras",     km: 235, dias: 1 },
  { d: "Playa El Tunco El Salvador",km: 275, dias: 2 },
];

export const GT = {
  "Guatemala":       ["Guatemala","Mixco","Villa Nueva","Amatitlán","Chinautla"],
  "Alta Verapaz":    ["Cobán","San Pedro Carchá","Chisec","Raxruhá"],
  ...
  "Petén":           ["Flores","San Benito","La Libertad","Sayaxché","Poptún"],
  "Quetzaltenango":  ["Quetzaltenango","Coatepéque","Zunil","Almolonga"],
  "Quiché":          ["Santa Cruz del Quiché","Chichicastenango","Nebaj","Ixcán"],
  "Retalhuleu":      ["Retalhuleu","Champerico","San Sebastián"],
  "Sacatepéquez":    ["Antigua Guatemala","Jocotenango","San Lucas Sacatepéquez"],
  "San Marcos":      ["San Marcos","Malacatán","Tajumulco","Catarina"],
  "Santa Rosa":      ["Cuilapa","Barberena","Chiquimulilla"],
  "Sololá":          ["Sololá","Panajachel","Santiago Atitlán","San Pedro La Laguna"],
  "Suchitepéquez":   ["Mazatenango","Cuyotenango"],
  "Totonicapán":     ["Totonicapán","Momostenango","San Francisco El Alto"],
  "Zacapa":          ["Zacapa","Estanzuela","Río Hondo","Gualán"],
};
...
export const FLUJO_RES = {
  pendiente:  [{ v: "confirmada", l: "✓ Confirmar", s: "primary" }, { v: "cancelada", l: "✗", s: "danger" }],
  confirmada: [{ v: "en_curso",   l: "▶ Iniciar",   s: "blue"    }, { v: "cancelada", l: "✗", s: "danger" }],
  en_curso:   [{ v: "completada", l: "✓ Completar", s: "primary" }, { v: "cancelada", l: "✗", s: "danger" }],
  completada: [],
